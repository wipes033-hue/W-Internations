...
className="relative bg-gradient-to-b from-[#2DD8E5] to-[#45B7D1] overflow-hidden
             min-h-[60vh] md:min-h-screen"
                     style={{
          backgroundImage: `url(/assets/wipes/hero-bg.png)`,
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl px-4 md:px-8 py-4 shadow-lg">
              <div className="flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center space-x-8">
                  ...
                  <a 
                  href="/#contact"
                  className="bg-[#12AB45] hover:bg-[#4ad478] text-white px-3 lg:px-4 py-2 rounded-xl text-sm lg:text-base font-medium">
                    Contact Us
                  </a>
                </div>
              </div>
              ...
              {isMobileMenuOpen && (
                <div className="md:hidden mt-4 pt-4 border-t border-gray-200">
                  <div className="flex flex-col space-y-4">
                    ...
                    <a
                      href="/#contact"
                     className="bg-[#12AB45] hover:bg-[#12AB45] text-white px-4 py-2 rounded-xl text-sm font-medium w-full">
                      Contact Us
                    </a>
                  </div>
                </div>
...
<h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-medium text-white leading-none mb-4 md:mb-6">
  Wipes
            ...
            <br/>
                        <h1 className="text-xl sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-light text-[#20482C] leading-none mb-2 md:mb-4">
              Trusted Quality. Everyday Luxury.
            </h1>
                        {/* <br/> */}
                        <h1 className="text-xl sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-light text-[#20482C] leading-none mb-2 md:mb-4">
              Made in India.
      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          <p className="text-gray-600 leading-relaxed mb-3">
            Wipes is the flagship brand of W International, delivering premium
            tissue and hygiene solutions designed to meet the highest
        ...
        <div className="flex justify-center space-x-6">
          <div className="relative w-80 h-52 md:w-92 md:h-60">
            <Image
              src="/assets/wipes/about-us.png" // replace with your actual path
              alt="Wipes Pack"
              layout="fill"
              objectFit="contain"
            />
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center mb-8 md:mb-12">
            <div className="inline-block">
              <h2 className="text-xl md:text-2xl lg:text-3xl font-medium text-[#157836] border-2 border-[#4FD97D] rounded-full px-6 md:px-8 py-3 md:py-4">
                Why Choose Wipes?
              </h2>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-6 md:gap-8">
              ...
              <div className="p-6">
                <h3 className="text-lg md:text-xl font-medium text-black mb-2">Direct Manufacturer & Supplier</h3>
                <p className="text-sm text-gray-600">No middlemen. We control quality, pricing, and supply from factory to client.</p>
              </div>
            </div>
            {/* WIPES Card */}
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                <h3 className="text-lg md:text-xl font-medium text-black mb-2">Premium Softness 
& Comfort </h3>
                <p className="text-sm text-gray-600">Crafted to deliver a gentle, luxurious feel in every use</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-gray-600">Engineered for strength without compromising softness</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                <h3 className="text-lg md:text-xl font-medium text-black mb-2">Eco-Friendly Commitment 
</h3>
                <p className="text-sm text-gray-600">Produced with sustainable practices and eco-conscious materials.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-sm md:text-base text-gray-700 leading-relaxed">
              Wipes is not just a product line,  it’s a trusted brand that symbolizes hygiene, reliability, and everyday luxury. 
              With an expanding client base and scalable manufacturing, Wipes is on track to become a global tissue 
              and hygiene leader.
            </p>
          </div>
        </div>
      ...
      {/* Footer Section */}
      <footer className="bg-gradient-to-r from-[#9EFFBE] to-[#2E7847] text-[#000000]">
    ...
    <div className="w-full max-w-sm">
      ...
      <div className="relative flex items-center">
        <input
          ...
          className="w-full px-4 py-3 rounded-full bg-[#4FD97D] text-black placeholder-black/60 focus:outline-none focus:bg-cyan-400/70 pr-14"
        />
        <button className="absolute right-1 bg-[#2B8346] hover:bg-[#2B8346] text-white p-3 rounded-full transition-colors">
        ...
        {/* Bottom Bar */}
        <div className="bg-[#2B8346]  border-t border-white/20 text-white">
